  ...
  async function handleAutoGenerate() {
    ...
    try {
      ...
      if (res.ok) {
        ...
        const link = { id, title: data.title, createdAt: new Date().toISOString(), url: interviewUrl(id), observeUrl: observerUrl(id), autoGenerated: true, roleType: autoRole, questionCount: data.questionCount }
        const updated = [link, ...quickLinks]
        setQuickLinks(updated)
        localStorage.setItem('hr_quick_links', JSON.stringify(updated))
      } else {
...
function CampaignCard({ campaign }) {
  const navigate = useNavigate()
  const toast = useToast()
  const link = interviewUrl(campaign.id)
