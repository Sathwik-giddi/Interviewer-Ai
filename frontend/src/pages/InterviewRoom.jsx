...
const S = {
  ...
  statusBar: { padding: '8px 14px', borderBottom: '1px solid var(--border)', background: 'var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexShrink: 0 },
  dot: { width: '8px', height: '8px', borderRadius: '50%', display: 'inline-block', flexShrink: 0 },
  videoBox: { position: 'relative', borderBottom: '1px solid var(--border)', flexShrink: 0 },
  videoLabel: { padding: '5px 12px', fontSize: '10px', fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--text-muted)', borderBottom: '1px solid var(--border)', background: 'var(--bg)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' },
  video: { width: '100%', aspectRatio: '16/9', objectFit: 'cover', display: 'block', background: '#000' },
  procOverlay: { position: 'absolute', bottom: '8px', left: '8px', right: '8px', display: 'flex', flexDirection: 'column', gap: '4px' },
  procWarn: { color: '#fff', padding: '6px 10px', fontSize: '12px', fontWeight: 600 },
  aiAvatar: { display: 'flex', alignItems: 'center', justifyContent: 'center', height: '90px', background: 'var(--primary-light)', position: 'relative', transition: 'background 0.4s ease' },
  ...
  procStatus: { padding: '8px 14px', borderBottom: '1px solid var(--border)', background: 'var(--bg)', flexShrink: 0 },
  hrBanner: { padding: '14px 16px', background: '#7353F6', border: 'none', display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontSize: '14px', color: '#fff', fontWeight: 700, flexShrink: 0, position: 'sticky', top: 0, zIndex: 20, gap: '12px', animation: 'pulse-bg 1.5s ease-in-out infinite' },
  ...
  progressBar: { height: '4px', background: 'var(--border)', width: '100%' },
  progressFill: { height: '100%', background: 'var(--primary)', transition: 'width 0.4s ease' },
  questionBox: { border: '1px solid var(--border)', padding: '20px', marginTop: '12px', display: 'flex', gap: '16px', alignItems: 'flex-start' },
  ...
  textarea: { marginTop: '12px', minHeight: '140px', width: '100%', padding: '12px', fontSize: '14px', border: '1px solid var(--border)', fontFamily: 'var(--font-body)', resize: 'vertical' },
  ...
  avatarBubble: { width: '24px', height: '24px', background: 'var(--primary, #7353F6)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginRight: '6px', marginTop: '2px' },
  dialogueMsg: { padding: '8px 10px', fontSize: '11px', maxWidth: '75%' },
  dialogueAi: { background: 'var(--bg-subtle, #f5f3ff)', border: '1px solid var(--border)', color: 'var(--text)' },
  dialogueCandidate: { background: 'linear-gradient(135deg, var(--primary, #7353F6), #38bdf8)', color: '#fff', border: 'none' },
}
