...
const S = {
  ...
  questionBox: { border: '1px solid var(--border)', padding: '20px', marginTop: '12px', display: 'flex', gap: '16px', alignItems: 'flex-start', borderRadius: '12px', background: '#FFFFFF' },
  ...
  textarea: { marginTop: '12px', minHeight: '140px', width: '100%', padding: '12px', fontSize: '14px', border: '1px solid var(--border)', fontFamily: 'var(--font-body)', resize: 'vertical', background: '#FFFFFF', color: 'var(--text)', borderRadius: '8px' },
  ...
  dialogueAi: { background: '#F8F9FC', border: '1px solid var(--border)', color: 'var(--text)' },
