...
const S = {
  ...
  statusBar: { padding: '10px 16px', borderBottom: '1px solid var(--border)', background: 'var(--bg-subtle)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexShrink: 0 },
  dot: { width: '10px', height: '10px', borderRadius: '50%', display: 'inline-block', flexShrink: 0 },
  videoBox: { borderBottom: '1px solid var(--border)', background: '#0a0a0a', position: 'relative', flexShrink: 0 },
  video: { width: '100%', aspectRatio: '16/9', objectFit: 'cover', display: 'block' },
  noVideo: { width: '100%', aspectRatio: '16/9', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#0a0a0a', color: 'var(--text-muted)' },
  ...
  tabBar: { display: 'flex', borderBottom: '1px solid var(--border)', background: 'var(--bg-subtle)', flexShrink: 0 },
  ...
  questionCard: { border: '1px solid var(--border)', padding: '16px 20px', background: 'var(--bg-glass)', borderRadius: '12px' },
  liveAnswer: { minHeight: '80px', padding: '12px', border: '1px solid var(--border)', background: 'var(--bg-glass)', fontSize: '14px', lineHeight: '1.6', whiteSpace: 'pre-wrap', borderRadius: '8px', color: 'var(--text)' },
  liveCode: { minHeight: '80px', padding: '12px', border: '1px solid var(--border)', background: 'rgba(0,0,0,0.3)', color: '#d4d4d4', fontSize: '13px', fontFamily: 'monospace', whiteSpace: 'pre-wrap', overflow: 'auto', maxHeight: '250px', borderRadius: '8px' },
}
