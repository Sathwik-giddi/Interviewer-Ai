...
const S = {
  ...
  questionCard: { border: '1px solid var(--border)', padding: '16px 20px', background: '#FFFFFF', borderRadius: '12px' },
  liveAnswer: { minHeight: '80px', padding: '12px', border: '1px solid var(--border)', background: '#F8F9FC', fontSize: '14px', lineHeight: '1.6', whiteSpace: 'pre-wrap', borderRadius: '8px', color: 'var(--text)' },
  liveCode: { minHeight: '80px', padding: '12px', border: '1px solid var(--border)', background: '#1E1E2E', color: '#d4d4d4', fontSize: '13px', fontFamily: 'monospace', whiteSpace: 'pre-wrap', overflow: 'auto', maxHeight: '250px', borderRadius: '8px' },
}
